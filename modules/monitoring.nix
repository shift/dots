...
in
{
  ...
  config = mkIf cfg.enable {
    ...
    systemd.tmpfiles.rules = [
      ...
      "d ${cfg.bufferConfig.directory} 0775 nobody nobody - -"
      "d ${cfg.bufferConfig.directory}/loki.source.journal.journal 0775 nobody nobody - -"
      "d ${cfg.bufferConfig.directory}/remotecfg 0775 nobody nobody - -"
      "d ${cfg.bufferConfig.directory}/prometheus.remote_write.grafana_prom 0775 nobody nobody - -"
      "d ${cfg.bufferConfig.directory}/prometheus.remote_write.grafana_prom/wal 0775 nobody nobody - -"
    ];
    ...
    sops.templates."grafana-alloy/config.alloy".mode = "0644";
